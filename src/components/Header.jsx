...
const Header = () => {
    return (
        ...
        className='text-3xl sm:text-6xl lg:text-[66px] font-Ovo'>
            IT professional based in San Francisco.
        </motion.h1>
        
        <motion.p initial={{opacity: 0}} whileInView={{opacity: 1}} transition={{duration: 0.6, delay: 0.7}}
        className='max-w-2xl mx-auto font-Ovo'>
            I am an IT security professional from California with expertise in security analysis, IAM administration, network administration and helpdesk.
        </motion.p>
        ...
        <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
            ...
            <motion.a initial={{y: 30, opacity: 0}} whileInView={{y: 0, opacity: 1}} transition={{duration: 0.6, delay: 1.2}} href="/sample-resume.pdf" download 
